...
Usage:
  python3 utilScript/swap_seme_valore.py --base-dir <path> [--output-csv <path>]
"""
...
def swap_seme_valore(base_dir, output_csv):
    BASE = Path(base_dir)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Swap seme e valore nei nomi file (es: A_1_0001 -> 1_A_0001)")
    parser.add_argument("--base-dir", required=True, help="Cartella base con sottocartelle")
    parser.add_argument("--output-csv", default="rename_swap_mapping.csv", help="File CSV output mapping")
    args = parser.parse_args()
    
    swap_seme_valore(args.base_dir, args.output_csv)
