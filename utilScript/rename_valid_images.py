...
#!/usr/bin/env python3
"""
Rinomina immagini nel validation set.
Formato: <numero>_<seme>_<xxxx>.<ext>

Usage:
  python3 utilScript/rename_valid_images.py --root-dir <path> [--mapping-csv <path>]
"""
import os
import shutil
import csv
...
def rename_valid_images(root, mapping_path):
    rows = []
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Rinomina immagini nel validation set")
    parser.add_argument("--root-dir", required=True, help="Cartella root del validation set")
    parser.add_argument("--mapping-csv", default="rename_valid_mapping.csv", help="File CSV output mapping")
    args = parser.parse_args()
    
    rename_valid_images(args.root_dir, args.mapping_csv)
